...
def create_word_count_fig(input_file):
    ...
    word_count_plot = data.iloc[:10, :2].plot.bar(
        x="word", y="count", color="blue", figsize=(5, 2), rot=0
    )
...
```{python}
# generate wordcount for isles
min_length = 1
word_count(
    input_file="../data/isles.txt",
    output_file="../output/isles.csv",
    min_length=min_length,
)
create_word_count_fig("../output/isles.csv")
```
...
```{python}
# generate wordcount for abyss
min_length = 1
word_count("../data/abyss.txt", "../output/abyss.csv", min_length)
create_word_count_fig("../output/abyss.csv")
```
...
```{python}
# generate wordcount for last
min_length = 1
word_count("../data/last.txt", "../output/last.csv", min_length)
create_word_count_fig("../output/last.csv")
```
...
```{python}
# generate wordcount for sierra
min_length = 1
word_count("../data/sierra.txt", "../output/sierra.csv", min_length)
create_word_count_fig("../output/sierra.csv")
```
